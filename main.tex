...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Technologies}{: HTML5, CSS3, Node.js, Express.js, Flutter, Linux} \\
...
%     \resumeSubHeadingListStart
%         \resumeSubheading{Teaching Assistant}{Fall Semester 2024-2025}{Calculus}{FAST NUCES Karachi}
%             \resumeItemListStart
%                 \resumeItem{Graded 3 assignments and 3 quizzes for a class of 53 students in the Calculus course during the Fall 2024–2025 semester.}
%                 \resumeItem{Provided constructive feedback to help students improve their understanding of core mathematical concepts.}
%             \resumeItemListEnd
%     \resumeSubHeadingListEnd
